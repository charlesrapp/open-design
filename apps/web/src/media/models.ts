...
export const MEDIA_PROVIDERS: MediaProvider[] = [
  ...
  },
  {
    id: 'pruna',
    label: 'Pruna AI',
    hint: 'p-image / p-image-edit / p-video — fast image + video on one endpoint',
    integrated: true,
    credentialsRequired: true,
    settingsVisible: true,
    defaultBaseUrl: 'https://api.pruna.ai/v1',
    docsUrl: 'https://docs.api.pruna.ai/guides/quickstart',
    supportsCustomModel: true,
    customModelPlaceholder: 'p-image or wan-t2v',
  },
  {
    id: 'leonardo',
    label: 'Leonardo.ai',
